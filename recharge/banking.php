        ...
        <div class="row">
            <div class="col-md-12">
                <div class="alert alert-secondary" role="alert">- Bạn vui lòng chuyển khoản chính xác nội dung chuyển
                    ...
                    <br> - Đối với Mbbank khung giờ từ 10h đến 12h tối không nên nạp vì sẽ bị delay.
                </div>
    </div>
    <div class="card-body bg-light overflow-hidden">
        <div class="row">
            <div class="mb-3 col-sm-6">
                <h5 class="text-info text-center"><img src="/assets/img/bankbing/momo.png" height="45px"></h5>
                <div class="alert alert-success" role="alert">Số Điện Thoại: <b><a href="javascript:;"
                            onclick="copyMomo();"><b>0846745505 </b><i class="far fa-copy"></i>
                        </a>
                    </b>
                    <br>Chủ tài khoản: <b>Bùi Văn Quyết</b>
                    <br>Số tiền tối thiểu: <b>20,000 VNĐ</b>
                </div>
                </div>
                <div class="card-body bg-light overflow-hidden">
        <div class="row">
            <div class="mb-3 col-sm-6">
                <h5 class="text-info text-center"><img src="/assets/img/bankbing/mbbank.png" height="45px"></h5>
                <div class="alert alert-success" role="alert">Số Tài Khoản: <b><a href="javascript:;"
                            onclick="copyAtm();"><b>0670105925555 </b><i class="far fa-copy"></i>
                        </a>
                    </b>
                    <br>Chủ tài khoản: <b>BUI VAN QUYET</b>
                    <br>Số tiền tối thiểu: <b>20,000 VNĐ</b>
                    </div>
                    </div>
                    <div class="card-body bg-light overflow-hidden">
        <div class="row">
            <div class="mb-3 col-sm-6">
                <h5 class="text-info text-center"><img src="/assets/img/bankbing/tsr.png" height="45px"></h5>
                <div class="alert alert-success" role="alert">Tên tài khoản: <b><a href="javascript:;"
                            onclick="copyTsr();"><b>quyetdz123 </b><i class="far fa-copy"></i>
                        </a>
                    </b>
                    <br>Chủ tài khoản: <b>BUI VAN QUYET</b>
                    <br>Số tiền tối thiểu: <b>20,000 VNĐ</b>
            ...
            <div class="col-md-12">
                ...
                <div class="alert alert-info" role="alert">
                    <h4 class="alert-heading font-weight-semi-bold text-center">
                        <a href="javascript:;" onclick="copyContent();"><b>SubQuaRe<?=$user_id;?></b>&nbsp;<i
            ...
            <div id="tableExample2"
                ...
                <div class="table-responsive scrollbar">
                    <table class="table table-bordered table-striped fs--1 mb-0">
                        ...
                        <tbody class="list">
                            <?php 
                        $result = mysqli_query($conn,"SELECT * FROM table_banking WHERE banking_id = '$user_id' ORDER BY banking_id DESC LIMIT 0,100");
...
function copyAtm() {
    var text = "0670105925555";
    copy(text);
    swal('Đã copy số Tài Khoản CK ATM!Mbbank', 'success');
}

function copyTsr() {
    var text = "quyetdz123";
    copy(text);
    swal('Đã copy số Tài Khoản CK TSR!', 'success');
}

function copyContent() {
    var text = "AutoMxhFb <?=$user_id;?>";
    copy(text);
