...
if ($_REQUEST) {
    ...
    $type   = $_REQUEST['type'];
    if ($type === 'buff-view-video-tiktok') {
        ...
        $urlCreateService        = 'https://automxh.vn/api/service/tiktok/view/order';
        $dataPostCreate          = array(
            'link_video' => $buff_fb_id,
            'amount' => $buff_amount,
            'note' => $buff_note
        );
        ...
        if (!filter_var($url, FILTER_VALIDATE_URL)) {
            ...
            mysqli_query($conn, "INSERT INTO table_buff(buff_username, buff_slug, buff_fb_id, buff_server, buff_amount, buff_note, buff_present, buff_payment, buff_status, buff_time) 
