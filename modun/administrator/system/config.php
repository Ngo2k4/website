...
if ($_REQUEST) {
    ...
    if ($type === 'config-site') {
        ...
        $site_autolike_partner_id  = htmlspecialchars(addslashes($_POST['site_autolike_partner_id']));
        $site_autolike_partner_key = htmlspecialchars(addslashes($_POST['site_autolike_partner_key']));
