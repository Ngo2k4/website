...
if ($_REQUEST) {
    ...
    if ($type === 'create-service') {
        ...
        if ($check_slug_available > 0) {
            ...
            if (mysqli_query($conn, "INSERT INTO table_service(service_title, service_slug, service_category, service_price, service_price_info, service_price_server_1, service_info_server_1, service_price_server_2, service_info_server_2, service_price_server_3, service_info_server_3, service_price_server_4, service_info_server_4, service_min_amount, service_max_amount, service_info, service_noted, service_status, service_time) 
            VALUES ('$service_title', '$service_slug', '$service_category', '$service_price', '$service_price_info', '$service_price_server_1', '$service_info_server_1', '$service_price_server_2', '$service_info_server_2', '$service_price_server_3', '$service_info_server_3', '$service_price_server_4', '$service_info_server_4', '$service_min_amount', '$service_max_amount', '$service_info', '$service_noted', '$service_status', '$service_time')")) {
