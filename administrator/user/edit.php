            ...
            <div class="card-header bg-light">
                <div class="row justify-content-between">
                    <div class="col-md-auto">
                        <h5 class="mb-3 mb-md-0"><?=$row['user_username'];?> 
                        </h5>
                    </div>
                    <div class="col-md-auto"><a class="btn btn-falcon-primary btn-sm"
                            href="/administrator/user/list"><span class="fas fa-list fs--2 mr-1"></span> Danh sách
                            người dùng</a>
                    </div>
                </div>
            </div>
                ...
                <form action="" method="POST" accept-charset="utf-8" class="user">
                    ...
                    <center>
                        <button type="button" class="btn btn-primary btn-rounded btn-block" id="submit"
                            onclick="edit_user();"><i class="fa fa-info"></i> Lưu thông tin</button>
                    </center>
                </form>
                </p>
            </div>
...
function edit_user() {
    ...
    $.ajax({
        url: WEBSITE_URL + prefix + 'administrator/user/edit.php',
        type: 'POST',
        dataType: 'JSON',
        data: {
            type: 'edit-user',
