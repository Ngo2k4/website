        ...
        <div class="card h-lg-100 overflow-hidden">
            <div class="card-header bg-light">
                <div class="row align-items-center">
                    <div class="col">
                        <h5 class="mb-0">Sửa số dư thành viên</h5>
                    </div>
                </div>
            </div>
            <div class="card-body bg-light">
                ...
                <form action="" method="POST" accept-charset="utf-8" class="user">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" class="form-control" id="user_id" placeholder="Nhập id của người dùng"
                            required="">
                    </div>
                    <div class="mb-3">
                        <label>Số tiền:</label>
                        <input type="number" class="form-control" id="user_point"
                            placeholder="Nhập số tiền cần cộng, trừ" required="">
                    </div>
                    <div class="mb-3">
                    ...
                    <center>
                        <button type="button" class="btn btn-primary btn-rounded btn-block" id="submit"
                            onclick="edit_point();"><i class="fa fa-info"></i> Thực hiện</button>
                    </center>
                </form>
                </p>
            </div>
...
function edit_point() {
    ...
    $.ajax({
        url: WEBSITE_URL + prefix + 'administrator/user/edit-point.php',
        type: 'POST',
        dataType: 'JSON',
        data: {
            type: 'edit-point',
