            ...
            <div class="card-body bg-light">
                ...
                <form action="" method="POST" accept-charset="utf-8" class="user">
                    <div class="row">
                        ...
                        <div class="form-group col-md-6">
                            <label>Token AutoLike:</label>
                            <input id="site_autolike_partner_id" type="text" class="form-control"
                                value="<?=$site_autolike_partner_id;?>" placeholder="Nhập facebook của trang">
                        </div>

                        <div class="form-group col-md-6">
                            <label>Key AutoLike:</label>
                            <input id="site_autolike_partner_key" type="text" class="form-control"
                                value="<?=$site_autolike_partner_key;?>" placeholder="Nhập facebook của trang">
                        </div>
                    ...
                    <center>
                        <button type="button" class="btn btn-info btn-rounded btn-block" id="submit"
                            onclick="config_site();"><i class="fa fa-info"></i> Lưu thông tin</button>
                    </center>
                </form>
                </p>
            </div>
...
function config_site() {
    ...
    var site_autolike_partner_id = $('#site_autolike_partner_id').val();
    var site_autolike_partner_key = $('#site_autolike_partner_key').val();
    ...
    $.ajax({
        url: WEBSITE_URL + prefix + 'administrator/system/config.php',
        type: 'POST',
        dataType: 'JSON',
        data: {
            type: 'config-site',
            ...
            site_autolike_partner_id: site_autolike_partner_id,
            site_autolike_partner_key: site_autolike_partner_key,
