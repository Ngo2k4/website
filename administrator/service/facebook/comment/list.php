...
$title = 'Danh sách đơn tăng bình luận Facebook';
            ...
            <div class="col-lg-8">
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item font-sans-serif active" aria-current="page"><i class="fas fa-link"></i>
                        Danh sách đơn tăng bình luận Facebook</li>
                </ol>
            </div>
        ...
        <div class="card mb-3">
            <div class="card-header bg-light">
                <div class="row justify-content-between">
                    <div class="col-md-auto">
                        <h5 class="mb-3 mb-md-0">Danh sách đơn tăng bình luận Facebook</h5>
                    </div>
            ...
            <div class="card-body">
                <div id="tableExample2"
                    data-list='{"valueNames":["buff_id","buff_time","buff_fb_id","buff_comment","buff_note","buff_present","buff_payment","buff_status"],"page":10,"pagination":true}'>
                    <div class="mb-3">
