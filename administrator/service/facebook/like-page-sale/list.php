...
$title = 'Danh sách đơn tăng like trang sale Facebook';
        ...
        <div class="row">
            <div class="col-lg-8">
                <ol class="breadcrumb">
                    ...
                    Danh sách đơn tăng like trang sale Facebook</li>
                </ol>
            </div>
            ...
            <div class="card-header bg-light">
                <div class="row justify-content-between">
                    <div class="col-md-auto">
                        <h5 class="mb-3 mb-md-0">Danh sách đơn tăng like trang sale Facebook</h5>
                    </div>
                ...
                <div id="tableExample2"
                    ...
                    <div class="table-responsive scrollbar">
                        <table class="table table-bordered table-striped fs--1 mb-0">
                            ...
                            <tbody class="list">
                                <?php 
                                $result = mysqli_query($conn, "SELECT * FROM table_buff WHERE buff_slug = 'buff-like-page-sale-facebook' ORDER BY buff_id DESC LIMIT 0,15");
