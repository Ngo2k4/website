...
$title = 'Danh sách đơn tăng like bài viết Facebook';
            ...
            <div class="col-lg-8">
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item font-sans-serif active" aria-current="page"><i class="fas fa-link"></i>
                        Danh sách đơn tăng like bài viết Facebook</li>
                </ol>
            </div>
        ...
        <div class="card mb-3">
            <div class="card-header bg-light">
                <div class="row justify-content-between">
                    <div class="col-md-auto">
                        <h5 class="mb-3 mb-md-0">Danh sách đơn tăng like bài viết Facebook</h5>
                    </div>
            ...
            <div class="card-body">
                <div id="tableExample2"
                    data-list='{"valueNames":["buff_id","buff_time","buff_fb_id","buff_reaction","buff_speed","buff_amount","buff_note","buff_present","buff_payment","buff_status"],"page":10,"pagination":true}'>
                    <div class="mb-3">
                    ...
                    <div class="table-responsive scrollbar">
                        <table class="table table-bordered table-striped fs--1 mb-0">
                            ...
                            <tbody class="list">
                                <?php 
                                $result = mysqli_query($conn, "SELECT * FROM table_buff WHERE buff_slug = 'buff-like-post-facebook' ORDER BY buff_id DESC LIMIT 0,15");
