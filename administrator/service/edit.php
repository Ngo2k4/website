            ...
            <div class="card-body bg-light">
                ...
                <form action="" method="POST" accept-charset="utf-8" class="user">
                    <div class="row">
                        ...
                        <div class="form-group col-md-6">
                            <label>Thông tin giá tiền:</label>
                            <input id="service_price_info" type="text" class="form-control"
                                value="<?=$row['service_price_info'];?>" placeholder="Nhập giá tiền server 1">
                        </div>
                        <div class="form-group col-md-6">
                        ...
                        <div class="form-group col-md-6">
                            <label>Thông tin server 1:</label>
                            <input id="service_info_server_1" type="text" class="form-control"
                                value="<?=$row['service_info_server_1'];?>" placeholder="Nhập giá tiền server 1">
                        </div>
                        <div class="form-group col-md-6">
                        ...
                        <div class="form-group col-md-6">
                            <label>Thông tin server 2:</label>
                            <input id="service_info_server_2" type="text" class="form-control"
                                value="<?=$row['service_info_server_2'];?>" placeholder="Nhập giá tiền server 1">
                        </div>
                        <div class="form-group col-md-6">
                        ...
                        <div class="form-group col-md-6">
                            <label>Thông tin server 3:</label>
                            <input id="service_info_server_3" type="text" class="form-control"
                                value="<?=$row['service_info_server_3'];?>" placeholder="Nhập giá tiền server 1">
                        </div>
                        <div class="form-group col-md-6">
                        ...
                        <div class="form-group col-md-6">
                            <label>Thông tin server 4:</label>
                            <input id="service_info_server_4" type="text" class="form-control"
                                value="<?=$row['service_info_server_4'];?>" placeholder="Nhập giá tiền server 1">
                        </div>
                        <div class="form-group col-md-6">
                    ...
                    <br />
                    <center>
                        <button type="button" class="btn btn-info btn-rounded btn-block" id="submit"
                            onclick="edit_service();"><i class="fa fa-info"></i> Lưu thông tin</button>
                    </center>
                </form>
                </p>
            </div>
...
function edit_service() {
    ...
    var service_price_info = $('#service_price_info').val();
    var service_price_server_1 = $('#service_price_server_1').val();
    var service_info_server_1 = $('#service_info_server_1').val();
    var service_price_server_2 = $('#service_price_server_2').val();
    var service_info_server_2 = $('#service_info_server_2').val();
    var service_price_server_3 = $('#service_price_server_3').val();
    var service_info_server_3 = $('#service_info_server_3').val();
    var service_price_server_4 = $('#service_price_server_4').val();
    var service_info_server_4 = $('#service_info_server_4').val();
    ...
    $.ajax({
        url: WEBSITE_URL + prefix + 'administrator/service/edit.php',
        type: 'POST',
        dataType: 'JSON',
        data: {
            type: 'edit-service',
            ...
            service_price_info: service_price_info,
            service_price_server_1: service_price_server_1,
            service_info_server_1: service_info_server_1,
            service_price_server_2: service_price_server_2,
            service_info_server_2: service_info_server_2,
            service_price_server_3: service_price_server_3,
            service_info_server_3: service_info_server_3,
            service_price_server_4: service_price_server_4,
            service_info_server_4: service_info_server_4,
        ...
        complete: function() {
            wait('#submit', true, '<i class="fa fa-info"></i> Thực hiện');
        },
        success: (data) => {
            if (data.error) {
                swal(data.msg, "error");
