        ...
        <div class="card h-lg-100 overflow-hidden">
            <div class="card-header bg-light">
                <div class="row justify-content-between">
                    <div class="col-md-auto">
                        <h5 class="mb-3 mb-md-0">Tạo dịch vụ mới
                        </h5>
                    </div>
                    <div class="col-md-auto"><a class="btn btn-falcon-primary btn-sm"
                            href="/administrator/service/list"><span class="fas fa-list fs--2 mr-1"></span> Danh sách
                            dịch vụ</a>
                    </div>
                </div>
            </div>
            <div class="card-body bg-light">
                ...
                <form action="" method="POST" accept-charset="utf-8" class="user">
                    ...
                    <br />
                    <center>
                        <button type="button" class="btn btn-success btn-rounded btn-block" id="submit"
                            onclick="create_service();"><i class="fa fa-info"></i> Tạo dịch vụ</button>
                    </center>
                </form>
                </p>
            </div>
...
function create_service() {
    ...
    $.ajax({
        url: WEBSITE_URL + prefix + 'administrator/service/create.php',
        type: 'POST',
        dataType: 'JSON',
        data: {
            type: 'create-service',
        ...
        complete: function() {
            wait('#submit', true, '<i class="fa fa-info"></i> Tạo dịch vụ');
        },
        success: (data) => {
            if (data.error) {
                swal(data.msg, "error");
