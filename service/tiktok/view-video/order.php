...
$result = mysqli_query($conn,"SELECT * FROM table_service WHERE service_slug = 'buff-view-video-tiktok'");
            ...
            <div class="card-header bg-light">
                <div class="row justify-content-between">
                    ...
                    <div class="col-md-auto"><a class="btn btn-falcon-primary btn-sm"
                            href="/service/tiktok/view-video/list"><span class="fas fa-list fs--2 mr-1"></span> Danh sách
                            đơn</a>
                    </div>
                </div>
            </div>
            <div class="card-body bg-light">
                ...
                <form action="" id="form_id" class="user" method="POST" accept-charset="utf-8">
                    <div class="mb-3">
                        ...
                        <label>(*) Link video phải là dạng <code>https://www.tiktok.com/@username/video/id_video</code></code>
                        </label>
                    </div>
                    <div class="mb-3">
                        <label>Máy chủ:</label>
                    ...
                    <div class="mb-3">
                        ...
                        <div class="alert alert-warning alert-dismissible fade show fs--1 text-center" role="alert">
                            Tổng tiền = (Số lượng) x (Giá 1 lượt xem) </div>
                    </div>
                    <div class="mb-3">
                        <label>Ghi chú:</label>
...
function buy_service() {
    ...
    $.ajax({
        url: WEBSITE_URL + prefix + 'service/tiktok/view-video/order.php',
        type: 'POST',
        dataType: 'JSON',
        data: {
